...
| *Method extension* (prompting beyond 0/few-shot) | 30 | `medqa/models/llm_qa.py::_build_prompt` (answer-type-conditioned prompting) + `medqa/retrieval/rag_pipeline.py::query` (UMLS query expansion + BGE cross-encoder re-ranking) |
...
| Qualitative evaluation     | 5       | `medqa/evaluation/qualitative.py::analyse_errors` (error categorisation: WRONG_RETRIEVAL, HALLUCINATION, etc.) |
